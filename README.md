...
- **Módulo de Compendio:** Buscador principal con autocompletado y filtros múltiples para consultar razas, clases, hechizos y monstruos del SRD.
- **Módulo de Creación:** Formularios interactivos paso a paso para la creación de personajes y contenido homebrew (reglas personalizadas) en tiempo real.
- **Módulo de Campaña:** Un panel de control (dashboard) para que los Directores de Juego organicen sus mundos, notas y marcadores rápidos.
