...
const fallbackColor = 'bg-amber-500/20 text-amber-300 border-amber-500/30'
    ...
    <Card className="border-amber-200/15 bg-amber-100/5 text-white transition-all hover:-translate-y-0.5 hover:border-amber-200/25 hover:bg-amber-100/8">
      <CardHeader>
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="flex-shrink-0 rounded-md bg-amber-100/10 px-2 py-0.5 text-xs font-semibold text-white/60">
            Niv. {conjuro.nivel}
          </span>
        </div>
        <div className="flex flex-wrap gap-1.5 pt-1">
          ...
          {conjuro.concentracion && (
            <Badge className="border border-amber-200/25 bg-amber-100/10 text-xs text-white/60">
              Concentración
            </Badge>
          )}
        </div>
